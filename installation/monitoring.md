...
kubevirt\_vmi\_memory\_resident\_bytes"default\_vm-test-01",name="vm-test-01",namespace="default",node="node01"
2.5595904e+07
kubevirt\_vmi\_network\_traffic\_bytes\_total"default\_vm-test-01",interface="vnet0",name="vm-test-01",namespace="default",node="node01",type="rx"
8431
kubevirt\_vmi\_network\_traffic\_bytes\_total"default\_vm-test-01",interface="vnet0",name="vm-test-01",namespace="default",node="node01",type="tx"
1835
kubevirt\_vmi\_vcpu\_seconds"default\_vm-test-01",id="0",name="vm-test-01",namespace="default",node="node01",state="1"
19 \`\`\`
